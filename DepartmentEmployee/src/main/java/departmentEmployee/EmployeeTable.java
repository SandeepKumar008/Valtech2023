...
public class EmployeeTable implements EmployeeDAO {
	...
	@Override
	public List<Employee> getEmployeeByDeptId(int did) throws SQLException {
		Connection conn = getConnection();
		PreparedStatement ps = conn.prepareStatement("SELECT EID, NAME, AGE, EXPERIENCE, SENIORITY, SALARY, DID FROM EMPLOYEE WHERE DID = ?");
		ps.setInt(1, did);
